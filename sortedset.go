...
//
// Time complexity of this method is : O(log(N))
func (this *SortedSet[K, SCORE, V]) GetByScoreRange(start SCORE, end SCORE, options *GetByScoreRangeOptions) []*SortedSetNode[K, SCORE, V] {
...
//
// Time complexity of this method is : O(log(N))
func (this *SortedSet[K, SCORE, V]) GetByRankRange(start int, end int, remove bool) []*SortedSetNode[K, SCORE, V] {
...
func (this *SortedSet[K, SCORE, V]) IterFuncByRankRange(start int, end int, fn func(key K, value V) bool) {
	if fn == nil {
		return
	}
